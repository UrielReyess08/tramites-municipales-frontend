  ...
  async function cargarHistorial() {
    try {
      ...
      if (response.ok) {
        ...
        console.log(
          "✅ Trámites recibidos del backend:",
          data.length,
          "trámites",
        );
        ...
        console.log(
          "📋 Campos disponibles:",
          data[0] ? Object.keys(data[0]) : "Sin datos",
        );
        ...
        const tramitesMapeados = data
          ...
          .map((t) => {
            ...
            return {
              ...
              fechaSolicitudTimestamp: createdAt
        ...
        tramitesMapeados.sort(
          (a, b) => b.fechaSolicitudTimestamp - a.fechaSolicitudTimestamp,
        );

        console.log(
          "📋 Trámites procesados y ordenados:",
          tramitesMapeados.length,
        );
        ...
        setStats({ total, completados, enProceso, rechazados });
      } else {
            ...
            <>
              ...
              <div className="space-y-4">
                {tramitesPaginados.map((tramite) => (
                  <TramiteHistorialCard key={tramite.id} tramite={tramite} />
                ))}
              </div>
              ...
              {totalPaginas > 1 && (
                <div className="mt-6 flex items-center justify-between">
                  <p className="text-[13px] text-black/50">
                    ...
                    {Math.min(indiceFin, tramitesFiltrados.length)} de{" "}
